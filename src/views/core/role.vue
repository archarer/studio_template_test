<template>
  <div class="app-container">
    ...
    <el-table :data="tableDataInfo.Data" row-key="RoleID" ref="DataTable" highlight-current-row @select-all="selectAllRow" @row-contextmenu="rowContextmenu" border fit style="width: 100%;">
      ...
      <el-table-column align="center" label="操作" v-if="device === 'mobile'&&contentMenuList.length>0" width="330" class-name="small-padding fixed-width">
        <template slot-scope="scope">
    ...
    <el-dialog :title="dialogEditTitle" :visible.sync="dialogEditVisible">
      <el-container>
        ...
        <el-aside>
          <el-main>
            <el-tree :data="menuData" show-checkbox node-key="id" :default-checked-keys="rowData.RoleMenuIds" :render-content="renderMenuContent" :expand-on-click-node="false" ref="menuTree" @check-change="setTreeKey" :check-strictly="true" v-loading="readMenuLoading" highlight-current>
            </el-tree>
          </el-main>
        </el-aside>
      </el-container>
